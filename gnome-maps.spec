...
Source0  : https://download.gnome.org/sources/gnome-maps/3.36/gnome-maps-3.36.2.tar.xz
...
%prep
%setup -q -n gnome-maps-3.36.2
cd %{_builddir}/gnome-maps-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588032297
...
cp %{_builddir}/gnome-maps-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-maps/23e13f8d523ce36d2547861c333e8e9c269f4c1a
cp %{_builddir}/gnome-maps-3.36.2/src/geojson-vt/LICENSE %{buildroot}/usr/share/package-licenses/gnome-maps/d59bb6ceea36fb0c66ed07ec231b74ecff15c94b
cp %{_builddir}/gnome-maps-3.36.2/src/togeojson/LICENSE %{buildroot}/usr/share/package-licenses/gnome-maps/af2a0e22eb18bfd67ae71eab3f5e85853a489ed0
cp %{_builddir}/gnome-maps-3.36.2/src/xmldom/LICENSE %{buildroot}/usr/share/package-licenses/gnome-maps/7079d60a22e0c83a63c2956ee65cb367af261521
